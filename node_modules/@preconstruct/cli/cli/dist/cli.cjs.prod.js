...
const validFieldsForEntrypoint = {
  main: entrypoint => getDistFilename(entrypoint, "cjs"),
  ...
  browser(entrypoint) {
    ...
    return entrypoint.package.exportsFieldConfig() ? moduleBuild : _objectSpread$1({
...
async function nonMemoizedGetProgram(typescript, configFileName) {
  ...
  thing.options.outDir = void 0, thing.options.declarationDir = void 0, thing.options.declaration = !0, 
  thing.options.emitDeclarationOnly = !0, thing.options.noEmit = !1;
